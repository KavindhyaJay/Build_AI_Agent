...
def chain(prompt):
    ...
    print("\nStep 1  Breakdown:\n  agent_with_memory.py:17 - prompt_chain_agent.py:17", step_1)
    ...
    print("\n[Explanation]  agent_with_memory.py:23 - prompt_chain_agent.py:23", step_2)

    #step 3 Ask agent for final summary
    step_3 = model.generate_content(
        f"Summarize the final answer in simple words: \nExplanation: {step_2}\nTask: {propmt}"
    ).text
    print("\n[Summary]  agent_with_memory.py:29 - prompt_chain_agent.py:29", step_3)
